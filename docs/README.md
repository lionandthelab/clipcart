...
살림해결소 affiliate 숏폼 자동화 프로젝트 설정 가이드.

| 문서 | 설명 |
|------|------|
| [platforms.md](./platforms.md) | Instagram · TikTok · Pinterest 연동 개요 |
| [instagram-setup.md](./instagram-setup.md) | Meta/Instagram 앱 등록 (복붙용) |
...
| [conversion-funnel.md](./conversion-funnel.md) | 전환 퍼널·링크 운영 (bio 페이지, CTA 컨벤션, subId 측정, 백필 스크립트) |
